...
public class MyProduct {
	...
	private String shopCode,shopName,shopAddress,shopMobile,prodName,prodCode,prodBarCode,prodDesc,prodHsnCode,prodMfgDate,prodExpiryDate,prodMfgBy,prodImage1,prodImage2,prodImage3,
	               createdBy,updatedBy,createdDate,updatedDate,status,offerId;

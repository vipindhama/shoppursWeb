...
public class ProductDao {
	...
	public String addRetailerProduct(List<MyProduct> listItem) {
        ...
        try {
        	...
        	String insertSql = "insert into ret_product (`PROD_ID`,`PROD_SUB_CAT_ID`,`PROD_NAME`,`PROD_CODE`," + 
        	...
        	for(MyProduct item : listItem) {
            	...
            	productJdbcTemplate.update(insertSql,prodId,item.getProdSubCatId(),item.getProdName(),item.getProdCode(),
